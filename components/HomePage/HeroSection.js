    ...
    <>
      <div className="ite mt-12 w-[300px] justify-center   text-center   capitalize md:w-full md:text-left">
        <div className="flex flex-col  md:w-[590px]  ">
          <div className=" font-monts  text-3xl font-bold  md:text-6xl">
...
function MobileImg() {
  return (
    <>
      <div className="mt-6  w-screen  justify-center     md:hidden ">
        <Image
          placeholder="blur"
...
function DesktopImg() {
  return (
    <>
      <div className=" mt-0 -mb-8 -mr-10 flex   h-full w-full items-end justify-center  p-4   ">
        <Image
          placeholder="blur"
          blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/RQAAuEB4mUJ9Y0AAAAASUVORK5CYII="
          priority
