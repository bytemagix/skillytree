      ...
      <div className="min-h-[30vh] items-center justify-center px-[5] pt-14">
        <div>
          <div className="flex justify-center">
            <span className="block text-center text-3xl font-[800]">
              Do u wish to guarantee
            </span>
          </div>
          <div className="flex justify-center">
            <span className="block text-center text-3xl font-[800]">
              yourself with a new skill
            </span>
          </div>
          <div className="flex justify-center">
            <span className="text-3xl font-[800]">within</span> &nbsp;&nbsp;
            <span className="text-3xl font-[800] text-pink">next 30 days?</span>
          </div>
        </div>
